...
当前数据规模：**13,392 个技术节点 + 约 1.8 万条依赖/赋能边**。
...
**techdiffusion** is a static, offline-browsable visualization database of human technology evolution. It connects ~13,392 technologies through their real historical dependencies into a single evolution network, paired with a deterministic analysis engine that:
