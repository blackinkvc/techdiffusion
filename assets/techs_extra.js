  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "玻璃纤维约 1930 年 出现，建立在 化学、经典力学 之上；它把 工具制造、结构件 变成可稳定复现的能力，是 材料体系 中从经验走向方法的关键一步。",
    "dependsOn": ["chemistry","physics"],
    "enables": [],
    "applications": [
      "工具制造",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，玻璃纤维仍是 工具制造 的底层支撑，并作为 材料体系 的基础能力持续发挥作用。"
      }
    ],
    "significance": "玻璃纤维把 化学 与 工具制造 连接起来，是 材料体系 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mat_cement",
    "name": "水泥",
