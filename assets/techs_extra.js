  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "数字符号系统在 公元前 3500 年 前后成形，依托 语言、计数 把 理论建模、实验测量 落到实处，并成为 科学基础与方法 中承上启下的一环，直接支撑了 量具 等后续技术。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，数字符号系统仍是 理论建模 的底层支撑，并持续影响 量具。"
      }
    ],
    "significance": "数字符号系统把 语言 与 理论建模 连接起来，是 科学基础与方法 中从「可能」走向「可用」的关键节点，并直接催生了 量具。"
  },
{
    "id": "arithmetic",
    "name": "算术",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "电化学在 1800 年 前后成形，依托 文字、数学 把 理论建模、实验测量 落到实处，并成为 科学基础与方法 中承上启下的一环，直接支撑了 电解加工、化学铣切、传真机 等后续技术。",
    "dependsOn": ["writing","mathematics"],
    "enables": [],
    "applications": [
      "理论建模",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，电化学仍是 理论建模 的底层支撑，并持续影响 电解加工、化学铣切、传真机。"
      }
    ],
    "significance": "电化学把 文字 与 理论建模 连接起来，是 科学基础与方法 中从「可能」走向「可用」的关键节点，并直接催生了 电解加工、化学铣切、传真机。"
  },
{
    "id": "cell_theory",
    "name": "细胞学说",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "铸铁约 公元前 500 年 成熟，建立在 块炼铁 之上完成关键突破；其能力延伸到 工具制造、结构件，并为 水泥与混凝土、渗碳、刨床 的发展铺平了道路。",
    "dependsOn": ["mat_iron"],
    "enables": [],
    "applications": [
      "工具制造",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，铸铁仍是 工具制造 的底层支撑，并持续影响 水泥与混凝土、渗碳、刨床。"
      }
    ],
    "significance": "铸铁把 块炼铁 与 工具制造 连接起来，是 材料体系 中从「可能」走向「可用」的关键节点，并直接催生了 水泥与混凝土、渗碳、刨床。"
  },
{
    "id": "mat_steel2",
    "name": "坩埚钢",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "粉末冶金约 1800 年 成熟，建立在 化学、经典力学 之上完成关键突破；其能力延伸到 工具制造、结构件，并为 钒、金属注射成形、热等静压 的发展铺平了道路。",
    "dependsOn": ["chemistry","physics"],
    "enables": [],
    "applications": [
      "工具制造",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，粉末冶金仍是 工具制造 的底层支撑，并持续影响 钒、金属注射成形、热等静压。"
      }
    ],
    "significance": "粉末冶金把 化学 与 工具制造 连接起来，是 材料体系 中从「可能」走向「可用」的关键节点，并直接催生了 钒、金属注射成形、热等静压。"
  },
{
    "id": "mat_sinter",
    "name": "烧结",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "锻造在 公元前 3000 年 前后成形，依托 青铜、木炭、用火 把 工具制造、结构件 落到实处，并成为 材料体系 中承上启下的一环，直接支撑了 模锻、电弧焊、板甲 等后续技术。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，锻造仍是 工具制造 的底层支撑，并持续影响 模锻、电弧焊、板甲。"
      }
    ],
    "significance": "锻造把 青铜 与 工具制造 连接起来，是 材料体系 中从「可能」走向「可用」的关键节点，并直接催生了 模锻、电弧焊、板甲。"
  },
{
    "id": "mat_casting",
    "name": "铸造",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "拉拔在 1200 年 前后成形，依托 车床 把 工具制造、结构件 落到实处，并成为 材料体系 中承上启下的一环，直接支撑了 轧制、挤出成型、拉丝 等后续技术。",
    "dependsOn": ["mfg_lathe"],
    "enables": [],
    "applications": [
      "工具制造",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，拉拔仍是 工具制造 的底层支撑，并持续影响 轧制、挤出成型、拉丝。"
      }
    ],
    "significance": "拉拔把 车床 与 工具制造 连接起来，是 材料体系 中从「可能」走向「可用」的关键节点，并直接催生了 轧制、挤出成型、拉丝。"
  },
{
    "id": "mat_extrusion",
    "name": "挤压成形",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "天然气利用在 1820 年 前后成形，依托 经典力学、化学 把 动力输出、照明加热 落到实处，并成为 能量形式 中承上启下的一环，直接支撑了 气焊 等后续技术。",
    "dependsOn": ["physics","chemistry"],
    "enables": [],
    "applications": [
      "动力输出",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，天然气利用仍是 动力输出 的底层支撑，并持续影响 气焊。"
      }
    ],
    "significance": "天然气利用把 经典力学 与 动力输出 连接起来，是 能量形式 中从「可能」走向「可用」的关键节点，并直接催生了 气焊。"
  },
{
    "id": "ene_oilshale",
    "name": "油页岩",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "刀具约 约 10 万年前 成熟，建立在 手斧 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 刀柄 的发展铺平了道路。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，刀具仍是 零件加工 的底层支撑，并持续影响 刀柄。"
      }
    ],
    "significance": "刀具把 手斧 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 刀柄。"
  },
{
    "id": "mfg_chisel",
    "name": "凿",
    ...
    "people": "",
    "place": "",
    "summary": "凿在 约 3 万年前 前后成形，依托 手斧 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 量具、弓、箭 等后续技术。",
    "dependsOn": ["mfg_handaxe"],
    "enables": [],
    "applications": [
      "零件加工",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，凿仍是 零件加工 的底层支撑，并持续影响 量具、弓、箭。"
      }
    ],
    "significance": "凿把 手斧 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 量具、弓、箭。"
  },
{
    "id": "mfg_hammer",
    "name": "锤",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "钻约 约 1 万年前 成熟，建立在 手斧 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 镗床、钻床 的发展铺平了道路。",
    "dependsOn": ["mfg_handaxe"],
    "enables": [],
    "applications": [
      "零件加工",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，钻仍是 零件加工 的底层支撑，并持续影响 镗床、钻床。"
      }
    ],
    "significance": "钻把 手斧 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 镗床、钻床。"
  },
{
    "id": "mfg_lathe",
    "name": "车床",
    ...
    "people": "",
    "place": "",
    "summary": "车床在 公元前 1000 年 前后成形，依托 数学、冶铁 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 拉拔、镗床、刨床 等后续技术。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，车床仍是 零件加工 的底层支撑，并持续影响 拉拔、镗床、刨床。"
      }
    ],
    "significance": "车床把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 拉拔、镗床、刨床。"
  },
{
    "id": "mfg_boring",
    "name": "镗床",
    ...
    "people": "",
    "place": "",
    "summary": "镗床约 1500 年 成熟，建立在 车床、钻 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 来复枪 的发展铺平了道路。",
    "dependsOn": ["mfg_lathe","mfg_drill"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "近代早期",
        "text": "镗床在 1500 年 前后出现，依托 车床 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "镗床把 车床 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 来复枪。"
  },
{
    "id": "mfg_mill",
    "name": "铣床",
    ...
    "people": "",
    "place": "",
    "summary": "铣床在 1818 年 前后成形，依托 数学、刨床 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 数控机床、车铣复合、搅拌摩擦焊 等后续技术。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，铣床仍是 零件加工 的底层支撑，并持续影响 数控机床、车铣复合、搅拌摩擦焊。"
      }
    ],
    "significance": "铣床把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 数控机床、车铣复合、搅拌摩擦焊。"
  },
{
    "id": "mfg_planer",
    "name": "刨床",
    ...
    "people": "",
    "place": "",
    "summary": "刨床在 1810 年 前后成形，依托 车床、铸铁 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 铣床、滑翔机、自行车 等后续技术。",
    "dependsOn": ["mfg_lathe","mat_castiron"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "工业革命",
        "text": "刨床在 1810 年 前后出现，依托 车床 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "刨床把 车床 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 铣床、滑翔机、自行车。"
  },
{
    "id": "mfg_grinder",
    "name": "磨床",
    ...
    "people": "",
    "place": "",
    "summary": "磨床约 1800 年 成熟，建立在 数学、可互换零件 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 切削液、电解磨削 的发展铺平了道路。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，磨床仍是 零件加工 的底层支撑，并持续影响 切削液、电解磨削。"
      }
    ],
    "significance": "磨床把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 切削液、电解磨削。"
  },
{
    "id": "mfg_drillpress",
    "name": "钻床",
    ...
    "people": "",
    "place": "",
    "summary": "钻床约 1800 年 出现，建立在 钻、车床 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_drill","mfg_lathe"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "工业革命",
        "text": "钻床在 1800 年 前后出现，依托 钻 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "钻床把 钻 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_cnc",
    "name": "数控机床",
    ...
    "people": "",
    "place": "",
    "summary": "数控机床在 1949 年 前后成形，依托 数学、电子计算机、伺服系统 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 加工中心、车铣复合、激光切割 等后续技术。",
    "dependsOn": ["mathematics","computer","mfg_servo","mfg_mill"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，数控机床仍是 零件加工 的底层支撑，并持续影响 加工中心、车铣复合、激光切割。"
      }
    ],
    "significance": "数控机床把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 加工中心、车铣复合、激光切割。"
  },
{
    "id": "mfg_mc",
    "name": "加工中心",
    ...
    "dependsOn": ["mfg_cnc","mfg_toolholder"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "加工中心在 1958 年 前后出现，依托 数控机床 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "加工中心把 数控机床 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_turnmill",
    "name": "车铣复合",
    ...
    "dependsOn": ["mfg_cnc","mfg_lathe","mfg_mill"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "车铣复合在 1980 年 前后出现，依托 数控机床 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "车铣复合把 数控机床 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_3dp",
    "name": "3D 打印",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，3D 打印仍是 零件加工 的底层支撑，并持续影响 增材制造、仿生制造、3D 打印建筑。"
      }
    ],
    "significance": "3D 打印把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 增材制造、仿生制造、3D 打印建筑。"
  },
{
    "id": "mfg_additive",
    "name": "增材制造",
  ...
  },
{
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "激光切割在 1965 年 前后出现，依托 激光器 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "激光切割把 激光器 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_waterjet",
    "name": "水射流切割",
    ...
    "dependsOn": ["jet_compressor","mfg_cnc"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "水射流切割在 1970 年 前后出现，依托 压气机 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，水射流切割仍是 零件加工 的底层支撑，并持续影响 磨料水射流。"
      }
    ],
    "significance": "水射流切割把 压气机 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 磨料水射流。"
  },
{
    "id": "mfg_plasma",
    "name": "等离子切割",
    ...
    "dependsOn": ["mfg_welding","electricity"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "等离子切割在 1950 年 前后出现，依托 电弧焊 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "等离子切割把 电弧焊 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_edm",
    "name": "电火花加工",
    ...
    "people": "",
    "place": "",
    "summary": "电火花加工在 1943 年 前后成形，依托 电力系统、电子学 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 线切割、电火花线切割机 等后续技术。",
    "dependsOn": ["electricity","electronics"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "电气时代",
        "text": "电火花加工在 1943 年 前后出现，依托 电力系统 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，电火花加工仍是 零件加工 的底层支撑，并持续影响 线切割、电火花线切割机。"
      }
    ],
    "significance": "电火花加工把 电力系统 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 线切割、电火花线切割机。"
  },
{
    "id": "mfg_wedm",
    "name": "线切割",
    ...
    "people": "",
    "place": "",
    "summary": "线切割约 1960 年 出现，建立在 电火花加工、拉丝 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_edm","mfg_wiredraw"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "线切割在 1960 年 前后出现，依托 电火花加工 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "线切割把 电火花加工 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_sandcast",
    "name": "砂型铸造",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "压铸约 1838 年 出现，建立在 模具、铸造 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_mold","mat_casting"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "工业革命",
        "text": "压铸在 1838 年 前后出现，依托 模具 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "压铸把 模具 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_forging2",
    "name": "模锻",
    ...
    "people": "",
    "place": "",
    "summary": "模锻在 1800 年 前后成形，依托 锻造、模具 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 冲压 等后续技术。",
    "dependsOn": ["mat_forging","mfg_mold"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "工业革命",
        "text": "模锻在 1800 年 前后出现，依托 锻造 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "模锻把 锻造 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 冲压。"
  },
{
    "id": "mfg_stamping",
    "name": "冲压",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "铆接在 公元前 2000 年 前后成形，依托 锤、青铜 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 潜艇 等后续技术。",
    "dependsOn": ["mfg_hammer","bronze"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "古代文明",
        "text": "铆接在 公元前 2000 年 前后出现，依托 锤 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "铆接把 锤 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 潜艇。"
  },
{
    "id": "mfg_welding",
    "name": "电弧焊",
    ...
    "people": "",
    "place": "",
    "summary": "电弧焊在 1881 年 前后成形，依托 电力系统、锻造 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 等离子切割、气焊、激光焊 等后续技术。",
    "dependsOn": ["electricity","mat_forging"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "工业革命",
        "text": "电弧焊在 1881 年 前后出现，依托 电力系统 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，电弧焊仍是 零件加工 的底层支撑，并持续影响 等离子切割、气焊、激光焊。"
      }
    ],
    "significance": "电弧焊把 电力系统 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 等离子切割、气焊、激光焊。"
  },
{
    "id": "mfg_gasweld",
    "name": "气焊",
    ...
    "people": "",
    "place": "",
    "summary": "气焊约 1900 年 出现，建立在 电弧焊、天然气利用 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_welding","ene_natgas"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "电气时代",
        "text": "气焊在 1900 年 前后出现，依托 电弧焊 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "气焊把 电弧焊 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_resistweld",
    "name": "电阻焊",
    ...
    "people": "",
    "place": "",
    "summary": "电阻焊约 1877 年 出现，建立在 发电机与电动机、电池 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["generator","battery"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "工业革命",
        "text": "电阻焊在 1877 年 前后出现，依托 发电机与电动机 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "电阻焊把 发电机与电动机 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_laserweld",
    "name": "激光焊",
    ...
    "people": "",
    "place": "",
    "summary": "激光焊约 1960 年 出现，建立在 激光器、电弧焊 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["lasers","mfg_welding"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "激光焊在 1960 年 前后出现，依托 激光器 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "激光焊把 激光器 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_fsw",
    "name": "搅拌摩擦焊",
    ...
    "people": "",
    "place": "",
    "summary": "搅拌摩擦焊约 1991 年 出现，建立在 电弧焊、铣床 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_welding","mfg_mill"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "搅拌摩擦焊在 1991 年 前后出现，依托 电弧焊 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "搅拌摩擦焊把 电弧焊 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_ebw",
    "name": "电子束焊",
    ...
    "people": "",
    "place": "",
    "summary": "电子束焊约 1958 年 出现，建立在 电子学、真空炉 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["electronics","mfg_vacfurnace"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "电子束焊在 1958 年 前后出现，依托 电子学 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "电子束焊把 电子学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_braze",
    "name": "钎焊",
    ...
    "people": "",
    "place": "",
    "summary": "钎焊约 公元前 2000 年 出现，建立在 青铜、窑 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["bronze","kiln"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "古代文明",
        "text": "钎焊在 公元前 2000 年 前后出现，依托 青铜 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "钎焊把 青铜 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_adhesive",
    "name": "胶接",
    ...
    "people": "",
    "place": "",
    "summary": "胶接约 公元前 2000 年 出现，建立在 复合工具、用火 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["hafting","fire"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "古代文明",
        "text": "胶接在 公元前 2000 年 前后出现，依托 复合工具 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "胶接把 复合工具 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_bolt",
    "name": "螺纹连接",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "螺纹在 公元前 300 年 前后成形，依托 高炉炼铁、数学、螺纹连接 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 刀柄、自行车、马镫 等后续技术。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，螺纹仍是 零件加工 的底层支撑，并持续影响 刀柄、自行车、马镫。"
      }
    ],
    "significance": "螺纹把 高炉炼铁 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 刀柄、自行车、马镫。"
  },
{
    "id": "mfg_standard",
    "name": "零件标准化",
    ...
    "people": "",
    "place": "",
    "summary": "零件标准化约 1800 年 成熟，建立在 可互换零件、量具 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 装配线、看板管理 的发展铺平了道路。",
    "dependsOn": ["interchangeable_parts","mfg_gauge"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "工业革命",
        "text": "零件标准化在 1800 年 前后出现，依托 可互换零件 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，零件标准化仍是 零件加工 的底层支撑，并持续影响 装配线、看板管理。"
      }
    ],
    "significance": "零件标准化把 可互换零件 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 装配线、看板管理。"
  },
{
    "id": "mfg_assembly",
    "name": "装配线",
    ...
    "people": "",
    "place": "",
    "summary": "装配线约 1900 年 出现，建立在 可互换零件、零件标准化 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["interchangeable_parts","mfg_standard"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "电气时代",
        "text": "装配线在 1900 年 前后出现，依托 可互换零件 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "装配线把 可互换零件 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_fixture",
    "name": "工装夹具",
    ...
    "people": "",
    "place": "",
    "summary": "工装夹具约 1800 年 出现，建立在 量具、车床 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_gauge","mfg_lathe"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "工业革命",
        "text": "工装夹具在 1800 年 前后出现，依托 量具 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "工装夹具把 量具 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_mold",
    "name": "模具",
    ...
    "people": "",
    "place": "",
    "summary": "模具在 公元前 3000 年 前后成形，依托 青铜铸造 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 压铸、模锻、注塑 等后续技术。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，模具仍是 零件加工 的底层支撑，并持续影响 压铸、模锻、注塑。"
      }
    ],
    "significance": "模具把 青铜铸造 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 压铸、模锻、注塑。"
  },
{
    "id": "mfg_injection",
    "name": "注塑",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，注塑仍是 零件加工 的底层支撑，并持续影响 吹塑、金属注射成形。"
      }
    ],
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "吹塑约 1930 年 出现，建立在 挤出成型、注塑 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_extrude2","mfg_injection"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "电气时代",
        "text": "吹塑在 1930 年 前后出现，依托 挤出成型 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "吹塑把 挤出成型 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_extrude2",
    "name": "挤出成型",
    ...
    "people": "",
    "place": "",
    "summary": "挤出成型约 1800 年 成熟，建立在 模具、拉拔 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 吹塑 的发展铺平了道路。",
    "dependsOn": ["mfg_mold","mat_drawing"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "工业革命",
        "text": "挤出成型在 1800 年 前后出现，依托 模具 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，挤出成型仍是 零件加工 的底层支撑，并持续影响 吹塑。"
      }
    ],
    "significance": "挤出成型把 模具 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 吹塑。"
  },
{
    "id": "mfg_rolling2",
    "name": "压延",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "拉丝约 1200 年 成熟，建立在 拉拔、数学 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 线切割、电火花线切割机、索道 的发展铺平了道路。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，拉丝仍是 零件加工 的底层支撑，并持续影响 线切割、电火花线切割机、索道。"
      }
    ],
    "significance": "拉丝把 拉拔 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 线切割、电火花线切割机、索道。"
  },
{
    "id": "mfg_furnace",
    "name": "热处理炉",
    ...
    "people": "",
    "place": "",
    "summary": "热处理炉在 1800 年 前后成形，依托 窑、风箱 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 真空炉、热等静压 等后续技术。",
    "dependsOn": ["kiln","bellows"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "工业革命",
        "text": "热处理炉在 1800 年 前后出现，依托 窑 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，热处理炉仍是 零件加工 的底层支撑，并持续影响 真空炉、热等静压。"
      }
    ],
    "significance": "热处理炉把 窑 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 真空炉、热等静压。"
  },
{
    "id": "mfg_vacfurnace",
    "name": "真空炉",
    ...
    "people": "",
    "place": "",
    "summary": "真空炉在 1950 年 前后成形，依托 热处理炉、电力系统 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 电子束焊 等后续技术。",
    "dependsOn": ["mfg_furnace","electricity"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "真空炉在 1950 年 前后出现，依托 热处理炉 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，真空炉仍是 零件加工 的底层支撑，并持续影响 电子束焊。"
      }
    ],
    "significance": "真空炉把 热处理炉 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 电子束焊。"
  },
{
    "id": "mfg_induction",
    "name": "感应加热",
    ...
    "people": "",
    "place": "",
    "summary": "感应加热约 1887 年 出现，建立在 电磁学、电力系统 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["electromagnetism","electricity"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "工业革命",
        "text": "感应加热在 1887 年 前后出现，依托 电磁学 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "感应加热把 电磁学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_shotblast",
    "name": "喷丸",
    ...
    "people": "",
    "place": "",
    "summary": "喷丸约 1930 年 出现，建立在 磨料、砂轮 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_abrasive","mfg_grindingwheel"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "电气时代",
        "text": "喷丸在 1930 年 前后出现，依托 磨料 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "喷丸把 磨料 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_polish",
    "name": "抛光",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "纳米压印约 1995 年 出现，建立在 纳米技术、模具 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["nanotech","mfg_mold"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "纳米压印在 1995 年 前后出现，依托 纳米技术 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "纳米压印把 纳米技术 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_ecm",
    "name": "电解加工",
    ...
    "people": "",
    "place": "",
    "summary": "电解加工约 1950 年 成熟，建立在 电化学、电力系统 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 电解磨削 的发展铺平了道路。",
    "dependsOn": ["electrochem","electricity"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "电解加工在 1950 年 前后出现，依托 电化学 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，电解加工仍是 零件加工 的底层支撑，并持续影响 电解磨削。"
      }
    ],
    "significance": "电解加工把 电化学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 电解磨削。"
  },
{
    "id": "mfg_chemill",
    "name": "化学铣切",
    ...
    "people": "",
    "place": "",
    "summary": "化学铣切约 1940 年 出现，建立在 化学、电化学 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["chemistry","electrochem"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "电气时代",
        "text": "化学铣切在 1940 年 前后出现，依托 化学 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "化学铣切把 化学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_pim",
    "name": "金属注射成形",
    ...
    "people": "",
    "place": "",
    "summary": "金属注射成形约 1970 年 出现，建立在 注塑、粉末冶金 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_injection","mat_powder"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "金属注射成形在 1970 年 前后出现，依托 注塑 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "金属注射成形把 注塑 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_hip",
    "name": "热等静压",
    ...
    "people": "",
    "place": "",
    "summary": "热等静压约 1955 年 出现，建立在 热处理炉、粉末冶金 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_furnace","mat_powder"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "热等静压在 1955 年 前后出现，依托 热处理炉 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "热等静压把 热处理炉 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_cmm",
    "name": "三坐标测量",
    ...
    "people": "",
    "place": "",
    "summary": "三坐标测量约 1950 年 成熟，建立在 数学、量具、滚珠丝杠 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 逆向工程、在机测量 的发展铺平了道路。",
    "dependsOn": ["mathematics","mfg_gauge","mfg_ballscrew"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，三坐标测量仍是 零件加工 的底层支撑，并持续影响 逆向工程、在机测量。"
      }
    ],
    "significance": "三坐标测量把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 逆向工程、在机测量。"
  },
{
    "id": "mfg_reverse",
    "name": "逆向工程",
    ...
    "people": "",
    "place": "",
    "summary": "逆向工程约 1980 年 出现，建立在 三坐标测量、计算机辅助设计 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_cmm","cad"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "逆向工程在 1980 年 前后出现，依托 三坐标测量 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "逆向工程把 三坐标测量 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_plc",
    "name": "可编程逻辑控制器",
    ...
    "people": "",
    "place": "",
    "summary": "可编程逻辑控制器约 1968 年 成熟，建立在 电子计算机、自动化 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 数字化车间 的发展铺平了道路。",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "可编程逻辑控制器在 1968 年 前后出现，依托 电子计算机 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，可编程逻辑控制器仍是 零件加工 的底层支撑，并持续影响 数字化车间。"
      }
    ],
    "significance": "可编程逻辑控制器把 电子计算机 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 数字化车间。"
  },
{
    "id": "mfg_servo",
    "name": "伺服系统",
    ...
    "people": "",
    "place": "",
    "summary": "伺服系统约 1940 年 成熟，建立在 电动机、电子学 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 数控机床、直线电机、自适应控制 的发展铺平了道路。",
    "dependsOn": ["electric_motor","electronics"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "电气时代",
        "text": "伺服系统在 1940 年 前后出现，依托 电动机 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，伺服系统仍是 零件加工 的底层支撑，并持续影响 数控机床、直线电机、自适应控制。"
      }
    ],
    "significance": "伺服系统把 电动机 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 数控机床、直线电机、自适应控制。"
  },
{
    "id": "mfg_ballscrew",
    "name": "滚珠丝杠",
    ...
    "people": "",
    "place": "",
    "summary": "滚珠丝杠约 1898 年 成熟，建立在 无线输电、数学 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 三坐标测量 的发展铺平了道路。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，滚珠丝杠仍是 零件加工 的底层支撑，并持续影响 三坐标测量。"
      }
    ],
    "significance": "滚珠丝杠把 无线输电 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 三坐标测量。"
  },
{
    "id": "mfg_linearmotor",
    "name": "直线电机",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "谐波减速器约 1955 年 出现，建立在 齿轮、精密轴承 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["gearing","mfg_precisionbearing"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "谐波减速器在 1955 年 前后出现，依托 齿轮 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "谐波减速器把 齿轮 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "精密轴承在 1883 年 前后成形，依托 水力发电站、数学 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 谐波减速器 等后续技术。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，精密轴承仍是 零件加工 的底层支撑，并持续影响 谐波减速器。"
      }
    ],
    "significance": "精密轴承把 水力发电站 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 谐波减速器。"
  },
{
    "id": "mfg_gauge",
    "name": "量具",
    ...
    "people": "",
    "place": "",
    "summary": "量具约 公元前 2000 年 成熟，建立在 数字符号系统、凿、木作 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 零件标准化、工装夹具、三坐标测量 的发展铺平了道路。",
    "dependsOn": ["numerals","mfg_chisel","woodworking"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "古代文明",
        "text": "量具在 公元前 2000 年 前后出现，依托 数字符号系统 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，量具仍是 零件加工 的底层支撑，并持续影响 零件标准化、工装夹具、三坐标测量。"
      }
    ],
    "significance": "量具把 数字符号系统 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 零件标准化、工装夹具、三坐标测量。"
  },
{
    "id": "mfg_spcc",
    "name": "统计过程控制",
    ...
    "people": "",
    "place": "",
    "summary": "统计过程控制约 1924 年 成熟，建立在 数学、流水线 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 六西格玛、全面质量管理 的发展铺平了道路。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，统计过程控制仍是 零件加工 的底层支撑，并持续影响 六西格玛、全面质量管理。"
      }
    ],
    "significance": "统计过程控制把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 六西格玛、全面质量管理。"
  },
{
    "id": "mfg_sixsigma",
    "name": "六西格玛",
    ...
    "people": "",
    "place": "",
    "summary": "六西格玛约 1986 年 出现，建立在 统计学、统计过程控制 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["statistics","mfg_spcc"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "六西格玛在 1986 年 前后出现，依托 统计学 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "六西格玛把 统计学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_lean",
    "name": "精益生产",
    ...
    "people": "",
    "place": "",
    "summary": "精益生产约 1950 年 出现，建立在 流水线、看板管理 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["assembly_line","mfg_kanban"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "精益生产在 1950 年 前后出现，依托 流水线 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "精益生产把 流水线 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_kanban",
    "name": "看板管理",
    ...
    "people": "",
    "place": "",
    "summary": "看板管理约 1940 年 成熟，建立在 流水线、零件标准化 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 精益生产 的发展铺平了道路。",
    "dependsOn": ["assembly_line","mfg_standard"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "电气时代",
        "text": "看板管理在 1940 年 前后出现，依托 流水线 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，看板管理仍是 零件加工 的底层支撑，并持续影响 精益生产。"
      }
    ],
    "significance": "看板管理把 流水线 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 精益生产。"
  },
{
    "id": "mfg_cam",
    "name": "计算机辅助制造",
    ...
    "people": "",
    "place": "",
    "summary": "计算机辅助制造约 1970 年 成熟，建立在 计算机辅助设计、数控机床 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 空间站、防抱死制动、建筑信息模型 的发展铺平了道路。",
    "dependsOn": ["cad","mfg_cnc"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "计算机辅助制造在 1970 年 前后出现，依托 计算机辅助设计 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "计算机辅助制造把 计算机辅助设计 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 空间站、防抱死制动、建筑信息模型。"
  },
{
    "id": "mfg_fms",
    "name": "柔性制造系统",
    ...
    "people": "",
    "place": "",
    "summary": "柔性制造系统约 1967 年 出现，建立在 数控机床、工业机器人 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_cnc","robot"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "柔性制造系统在 1967 年 前后出现，依托 数控机床 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "柔性制造系统把 数控机床 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_adaptive",
    "name": "自适应控制",
    ...
    "people": "",
    "place": "",
    "summary": "自适应控制约 1950 年 出现，建立在 控制论、伺服系统 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["control_theory","mfg_servo"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "自适应控制在 1950 年 前后出现，依托 控制论 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "自适应控制把 控制论 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_digitaltwin",
    "name": "数字孪生",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "协作机器人约 1996 年 出现，建立在 工业机器人、传感器 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["robot","sensor"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "协作机器人在 1996 年 前后出现，依托 工业机器人 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "协作机器人把 工业机器人 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_selfassemble",
    "name": "自组装",
    ...
    "people": "",
    "place": "",
    "summary": "自组装约 1990 年 出现，建立在 纳米技术、化学 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["nanotech","chemistry"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "自组装在 1990 年 前后出现，依托 纳米技术 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "自组装把 纳米技术 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_bionics",
    "name": "仿生制造",
    ...
    "people": "",
    "place": "",
    "summary": "仿生制造约 1990 年 出现，建立在 材料科学、3D 打印 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["materials","mfg_3dp"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "仿生制造在 1990 年 前后出现，依托 材料科学 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "仿生制造把 材料科学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "砂轮约 1840 年 成熟，建立在 磨料、窑 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 喷丸 的发展铺平了道路。",
    "dependsOn": ["mfg_abrasive","kiln"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "工业革命",
        "text": "砂轮在 1840 年 前后出现，依托 磨料 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，砂轮仍是 零件加工 的底层支撑，并持续影响 喷丸。"
      }
    ],
    "significance": "砂轮把 磨料 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 喷丸。"
  },
{
    "id": "mfg_abrasive",
    "name": "磨料",
    ...
    "people": "",
    "place": "",
    "summary": "磨料约 公元前 5000 年 成熟，建立在 手斧 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 喷丸、抛光、砂轮 的发展铺平了道路。",
    "dependsOn": ["mfg_handaxe"],
    "enables": [],
    "applications": [
      "零件加工",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，磨料仍是 零件加工 的底层支撑，并持续影响 喷丸、抛光、砂轮。"
      }
    ],
    "significance": "磨料把 手斧 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 喷丸、抛光、砂轮。"
  },
{
    "id": "mfg_toolholder",
    "name": "刀柄",
    ...
    "people": "",
    "place": "",
    "summary": "刀柄在 1900 年 前后成形，依托 刀具、螺纹 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 加工中心 等后续技术。",
    "dependsOn": ["mfg_knife","mfg_thread"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "电气时代",
        "text": "刀柄在 1900 年 前后出现，依托 刀具 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，刀柄仍是 零件加工 的底层支撑，并持续影响 加工中心。"
      }
    ],
    "significance": "刀柄把 刀具 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 加工中心。"
  },
{
    "id": "mfg_coolant",
    "name": "切削液",
    ...
    "people": "",
    "place": "",
    "summary": "切削液在 1900 年 前后成形，依托 车床、磨床 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 低温切削 等后续技术。",
    "dependsOn": ["mfg_lathe","mfg_grinder"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "电气时代",
        "text": "切削液在 1900 年 前后出现，依托 车床 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，切削液仍是 零件加工 的底层支撑，并持续影响 低温切削。"
      }
    ],
    "significance": "切削液把 车床 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 低温切削。"
  },
{
    "id": "mfg_edmwire",
    "name": "电火花线切割机",
    ...
    "people": "",
    "place": "",
    "summary": "电火花线切割机约 1960 年 出现，建立在 电火花加工、拉丝 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_edm","mfg_wiredraw"],
    "enables": [],
    "applications": [
      "零件加工",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "电火花线切割机在 1960 年 前后出现，依托 电火花加工 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "电火花线切割机把 电火花加工 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_roboticweld",
    "name": "焊接机器人",
    ...
    "people": "",
    "place": "",
    "summary": "焊接机器人约 1980 年 出现，建立在 工业机器人、电弧焊 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["robot","mfg_welding"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "焊接机器人在 1980 年 前后出现，依托 工业机器人 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "焊接机器人把 工业机器人 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_agv",
    "name": "自动导引车",
    ...
    "people": "",
    "place": "",
    "summary": "自动导引车约 1953 年 出现，建立在 电动机、传感器 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["electric_motor","sensor"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "自动导引车在 1953 年 前后出现，依托 电动机 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "自动导引车把 电动机 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_aps",
    "name": "高级计划排程",
    ...
    "people": "",
    "place": "",
    "summary": "高级计划排程在 1990 年 前后成形，依托 最优化/线性规划、电子计算机 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 制造执行系统 等后续技术。",
    "dependsOn": ["optimization","computer"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "高级计划排程在 1990 年 前后出现，依托 最优化/线性规划 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "高级计划排程把 最优化/线性规划 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 制造执行系统。"
  },
{
    "id": "mfg_quality",
    "name": "全面质量管理",
    ...
    "people": "",
    "place": "",
    "summary": "全面质量管理约 1950 年 出现，建立在 统计过程控制、统计学 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_spcc","statistics"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "全面质量管理在 1950 年 前后出现，依托 统计过程控制 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "全面质量管理把 统计过程控制 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_mes",
    "name": "制造执行系统",
    ...
    "people": "",
    "place": "",
    "summary": "制造执行系统约 1990 年 成熟，建立在 数学、高级计划排程 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 数字化车间 的发展铺平了道路。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，制造执行系统仍是 零件加工 的底层支撑，并持续影响 数字化车间。"
      }
    ],
    "significance": "制造执行系统把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 数字化车间。"
  },
{
    "id": "mfg_industry40",
    "name": "工业 4.0",
    ...
    "views": [
      {
        "period": "智能时代",
        "text": "工业 4.0在 2011 年 前后出现，依托 物联网 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "工业 4.0把 物联网 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_ecmg",
    "name": "电解磨削",
    ...
    "people": "",
    "place": "",
    "summary": "电解磨削约 1960 年 出现，建立在 电解加工、磨床 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_ecm","mfg_grinder"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "电解磨削在 1960 年 前后出现，依托 电解加工 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "电解磨削把 电解加工 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_ultrasonicm",
    "name": "超声加工",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "磨料水射流约 1980 年 出现，建立在 水射流切割、磨料 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_waterjet","mfg_abrasive"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "磨料水射流在 1980 年 前后出现，依托 水射流切割 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "磨料水射流把 水射流切割 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_hybridm",
    "name": "增减材混合制造",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "刀具状态监控约 1990 年 出现，建立在 传感器、数控机床 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["sensor","mfg_cnc"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "刀具状态监控在 1990 年 前后出现，依托 传感器 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "刀具状态监控把 传感器 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_cryogenicm",
    "name": "低温切削",
    ...
    "dependsOn": ["cryogenics","mfg_coolant"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "智能时代",
        "text": "低温切削在 2000 年 前后出现，依托 低温工程 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "低温切削把 低温工程 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_onmachinem",
    "name": "在机测量",
    ...
    "people": "",
    "place": "",
    "summary": "在机测量约 1990 年 出现，建立在 三坐标测量、数控机床 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["mfg_cmm","mfg_cnc"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "在机测量在 1990 年 前后出现，依托 三坐标测量 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "在机测量把 三坐标测量 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_robotgripper",
    "name": "机器人夹爪",
    ...
    "people": "",
    "place": "",
    "summary": "机器人夹爪约 1980 年 出现，建立在 工业机器人、作动器 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    "dependsOn": ["robot","actuator"],
    "enables": [],
    "applications": [
      "零件加工",
      "批量制造",
    ...
    "views": [
      {
        "period": "信息时代",
        "text": "机器人夹爪在 1980 年 前后出现，依托 工业机器人 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "机器人夹爪把 工业机器人 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_visionguide",
    "name": "视觉引导装配",
    ...
    "views": [
      {
        "period": "智能时代",
        "text": "视觉引导装配在 2000 年 前后出现，依托 传感器 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
    ...
    "significance": "视觉引导装配把 传感器 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_digitalshop",
    "name": "数字化车间",
    ...
    "views": [
      {
        "period": "智能时代",
        "text": "数字化车间在 2010 年 前后出现，依托 制造执行系统 解决了 制造与工具 中的具体难题，使相关能力第一次可被稳定复现。"
      },
      {
        "period": "当代",
        "text": "今天，数字化车间仍是 零件加工 的底层支撑，并持续影响 工业 4.0、无人化工厂。"
      }
    ],
    "significance": "数字化车间把 制造执行系统 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 工业 4.0、无人化工厂。"
  },
{
    "id": "mfg_darkfactory",
    "name": "无人化工厂",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "压气机在 1937 年 前后成形，依托 铸铁 把 能量形式 落到实处，并成为 能量形式 中承上启下的一环，直接支撑了 喷气发动机、水射流切割、涡轮段 等后续技术。",
    "dependsOn": ["mat_castiron"],
    "enables": [],
    "applications": [],
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，压气机仍是 能量形式 的底层支撑，并持续影响 喷气发动机、水射流切割、涡轮段。"
      }
    ],
    "significance": "压气机把 铸铁 与 能量形式 连接起来，是 能量形式 中从「可能」走向「可用」的关键节点，并直接催生了 喷气发动机、水射流切割、涡轮段。"
  },
{
    "id": "jet_turbine",
    "name": "涡轮段",
