  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "锻造在 公元前 3000 年 前后成形，依托 青铜、木炭、用火 把 工具制造、结构件 落到实处，并成为 材料体系 中承上启下的一环，直接支撑了 电弧焊、板甲 等后续技术。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，锻造仍是 工具制造 的底层支撑，并持续影响 电弧焊、板甲。"
      }
    ],
    "significance": "锻造把 青铜 与 工具制造 连接起来，是 材料体系 中从「可能」走向「可用」的关键节点，并直接催生了 电弧焊、板甲。"
  },
{
    "id": "mat_casting",
    "name": "铸造",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "磨床约 1800 年 成熟，建立在 数学、可互换零件 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 切削液 的发展铺平了道路。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，磨床仍是 零件加工 的底层支撑，并持续影响 切削液。"
      }
    ],
    "significance": "磨床把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 切削液。"
  },
{
    "id": "mfg_drillpress",
    "name": "钻床",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "数控机床在 1949 年 前后成形，依托 数学、电子计算机、伺服系统 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 加工中心、车铣复合、刀具状态监控 等后续技术。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，数控机床仍是 零件加工 的底层支撑，并持续影响 加工中心、车铣复合、刀具状态监控。"
      }
    ],
    "significance": "数控机床把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 加工中心、车铣复合、刀具状态监控。"
  },
{
    "id": "mfg_mc",
    "name": "加工中心",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "电弧焊在 1881 年 前后成形，依托 电力系统、锻造 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 气焊、激光焊、搅拌摩擦焊 等后续技术。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，电弧焊仍是 零件加工 的底层支撑，并持续影响 气焊、激光焊、搅拌摩擦焊。"
      }
    ],
    "significance": "电弧焊把 电力系统 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 气焊、激光焊、搅拌摩擦焊。"
  },
{
    "id": "mfg_gasweld",
    "name": "气焊",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "真空炉在 1950 年 前后成形，依托 数学 把 零件加工、批量制造 落到实处，并成为 制造与工具 中承上启下的一环，直接支撑了 电子束焊 等后续技术。",
    "dependsOn": ["mathematics"],
    "enables": [],
    "applications": [
      "零件加工",
    ...
    "significance": "真空炉把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 电子束焊。"
  },
{
    "id": "mfg_induction",
    "name": "感应加热",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "三坐标测量约 1950 年 成熟，建立在 数学、量具、滚珠丝杠 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 在机测量 的发展铺平了道路。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，三坐标测量仍是 零件加工 的底层支撑，并持续影响 在机测量。"
      }
    ],
    "significance": "三坐标测量把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 在机测量。"
  },
{
    "id": "mfg_reverse",
    "name": "逆向工程",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "伺服系统约 1940 年 成熟，建立在 数学 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 数控机床、直线电机、扫描振镜 的发展铺平了道路。",
    "dependsOn": ["mathematics"],
    "enables": [],
    "applications": [
      "零件加工",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，伺服系统仍是 零件加工 的底层支撑，并持续影响 数控机床、直线电机、扫描振镜。"
      }
    ],
    "significance": "伺服系统把 数学 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 数控机床、直线电机、扫描振镜。"
  },
{
    "id": "mfg_ballscrew",
    "name": "滚珠丝杠",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "量具约 公元前 2000 年 成熟，建立在 数字符号系统、凿、木作 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 三坐标测量 的发展铺平了道路。",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，量具仍是 零件加工 的底层支撑，并持续影响 三坐标测量。"
      }
    ],
    "significance": "量具把 数字符号系统 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 三坐标测量。"
  },
{
    "id": "mfg_spcc",
    "name": "统计过程控制",
  ...
  },
{
    ...
    "people": "",
    "place": "",
    "summary": "砂轮约 1840 年 出现，建立在 磨料、窑 之上；它把 零件加工、批量制造 变成可稳定复现的能力，是 制造与工具 中从经验走向方法的关键一步。",
    ...
    "significance": "砂轮把 磨料 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点。"
  },
{
    "id": "mfg_abrasive",
    "name": "磨料",
    ...
    "people": "",
    "place": "",
    "summary": "磨料约 公元前 5000 年 成熟，建立在 手斧 之上完成关键突破；其能力延伸到 零件加工、批量制造，并为 抛光、砂轮 的发展铺平了道路。",
    "dependsOn": ["mfg_handaxe"],
    "enables": [],
    "applications": [
      "零件加工",
    ...
    "views": [
      ...
      {
        "period": "当代",
        "text": "今天，磨料仍是 零件加工 的底层支撑，并持续影响 抛光、砂轮。"
      }
    ],
    "significance": "磨料把 手斧 与 零件加工 连接起来，是 制造与工具 中从「可能」走向「可用」的关键节点，并直接催生了 抛光、砂轮。"
  },
{
    "id": "mfg_toolholder",
    "name": "刀柄",
