...
const TECHS = [
  ...
  { id:"steam_ship", name:"蒸汽船", en:"Steam Ship", category:"transport", era:"industrial", date:"1807 年", year:1807,
    ...
    dependsOn: ["steam_engine","iron","mat_plating"], enables:["global_trade","canal"],
  ...
  { id:"space_station", name:"空间站", en:"Space Station", category:"transport", era:"intelligent", date:"1998 年", year:1998,
    ...
    dependsOn: ["satellite","rocket","mfg_cam","tr_supersonic"], enables:["space_economy","mars(未来)"],
  ...
  { id:"telegraph", name:"电报", en:"Telegraph", category:"info", era:"industrial", date:"1837 年", year:1837,
    ...
    dependsOn: ["writing","mat_alu","mathematics"], enables:["telephone","internet","global_news"],
  ...
  { id:"llm", name:"大语言模型", en:"Large Language Models", category:"info", era:"intelligent", date:"2017 / 2022 年", year:2017,
    ...
    dependsOn: ["ai","internet","ic","transformer_arch","mathematics"], enables:["agent","copilot","knowledge_work"],
  ...
  { id:"cannon", name:"火炮", en:"Cannon", category:"military", era:"medieval", date:"约 1300 年", year:1300,
    ...
    dependsOn: ["gunpowder","iron","bronze","mfg_wiredraw","mat_drawing","tr_horseshoe"], enables:["fortification_change","naval_war"],
  ...
  { id:"tank", name:"坦克", en:"Tank", category:"military", era:"electrical", date:"1916 年", year:1916,
    ...
    dependsOn: ["internal_combustion","steel","cannon","assembly_line","mat_stainless","tr_panama"], enables:["blitzkrieg","mechanized_war"],
