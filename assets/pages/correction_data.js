  ...
  entries: [
    ...
    },
    {
      ...
      "changes": [
        ...
        "③ 全库打标结果（机械兜底）：主维度求解路径 prefix 1,838 / cat 255 / prefix:bx 160 / hub-head 14；任务域路径 p2 826 / kw 809 / p1 432 / catSub 200。门类分布 eng 857、life 339、info 283、matter 250、mil 237、math 126、phys 90、symbol 69、chem 10、earth 6。**分布偏斜是机械兜底的已知局限**（前缀只能定位到「工程与建造」一层，细分由任务域承载），零命中任务域 2 个（`energy/animal_human`、`manufact/food_proc`），均由 D1 例外表逐条修正。",
