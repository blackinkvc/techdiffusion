  ...
  entries: [
    {
      ...
      category: "meta",
      severity: "高",
      status: "进行中（已修 5 例样本 + 重名合并 + 前置性质标注试点 + 全量重建首批 5 例；余下重建待批）",
      ...
      changes: [
        ...
        "待办（未做，待用户审核后执行）：① 按语义白名单继续重建剩余 778 条位置边（首批 5 例已完成）；② 重写 1027 条模板文案；③ 修 37 个「100% 模板依赖」节点（首批已覆盖 inf_switchboard / tr_suez / tr_cablecar / mfg_injection / inf_wifi 5 个）；④ 拆 512 条同年份退化链；⑤ 其余 22 组同名节点去重；⑥ 复核 12 条 enables 悬空引用（本轮未动）；⑦ kinds 逐条覆盖由 18 个节点扩到关键节点（兜底之外的细化）。"
      ],
      files: [
