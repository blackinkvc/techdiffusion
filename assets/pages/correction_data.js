  ...
  entries: [
    {
      ...
      category: "meta",
      severity: "高",
      status: "进行中（已修 5 例样本 + 重名合并 + 前置性质标注试点；全库重建待批）",
      ...
      changes: [
        ...
        "待办（未做，待用户审核后执行）：① 按分类语义白名单重建 787 条位置边；② 重写 1027 条模板文案；③ 修 37 个「100% 模板依赖」节点；④ 拆 512 条同年份退化链；⑤ 其余 22 组同名节点去重；⑥ 复核 12 条 enables 悬空引用（本轮未动）；⑦ kinds 逐条覆盖由 17 个节点扩到关键节点（兜底之外的细化）。"
      ],
      files: [
