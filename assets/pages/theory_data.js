...
window.THEORY = {
  ...
  nodes: {
    ...
    qft: { layer: "theory", field: "量子场论", note: "语料 1948（朝永/施温格/费曼重正化）；与 quantum_field（1950）同名，疑为重复条目" },
    quantum_field: { layer: "theory", field: "量子场论", note: "语料 1950；与 qft（1948）同名「量子场论」——实为重复节点，建议后续合并，暂各自标注" },
